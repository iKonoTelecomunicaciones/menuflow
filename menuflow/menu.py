...
class Variable(SerializableAttrs):
    ...
    value: str = attr.ib(metadata={"json": "value"})
...
class Filter(SerializableAttrs):
    ...
    variable: str = attr.ib(default=None, metadata={"json": "variable"})
    else_o_connection: ElseOConnection = attr.ib(default=None, metadata={"json": "else_o_connection"})
    o_connection: OConnection = attr.ib(default=None, metadata={"json": "o_connection"})
...
class Menu(SerializableAttrs):
    id: str = attr.ib(metadata={"json": "id"})
    global_variables: Optional[List[Variable]] = attr.ib(metadata={"json": "global_variables"}, factory=list)
    messages: List[Message] = attr.ib(metadata={"json": "messages"}, factory=list)
    filters:  List[Filter] = attr.ib(metadata={"json": "filters"}, factory=list)
